...
/*   Updated: 2025/11/20 15:39:21 by skhalil          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	handle_special_var(char *input, int *i, t_expand_ctx *ctx)
{
	char	*pid_str;
...
void	handle_env_var(char *input, int *i, t_expand_ctx *ctx)
{
	char	*name;
	char	*value;
